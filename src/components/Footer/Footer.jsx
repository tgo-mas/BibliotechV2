  ...
  return (
    <>
      <footer className="text-center dark text-lg-start text-muted">
        <section
          className={
            "header d-flex justify-content-center justify-content-lg-between p-2 " +
            darkMode
          }
        >
          <div className="me-3 d-none d-lg-block fw-bold">
            <span>SE CONECTE AS NOSSAS REDES SOCIAIS:</span>
          </div>
          ...
          <div className="container text-center text-md-start">
            <div className="row p-2">
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                <h4 className="text-uppercase fw-bold mb-4">BIBLIOTECH</h4>
                <p>Seu sistema digital de gestão de biblioteca.</p>
              </div>
              <div className="col-md-2 col-sm-2 col-xl-2 mx-auto mb-2">
                ...
                <p>
                  <Link to="/Politica" className="text-reset">
                    {" "}
                    Politica{" "}
                  </Link>
                </p>
              ...
              <div className="col-md-4 col-sm-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <p>
                  <i className="bi bi-envelope me-3"></i>bibliotech@contato.com
                </p>
                <p>
        ...
        <div className={"end  text-center p-2 " + darkMode}>
          <Link className="text-reset fw-bold textDecorationB" to="#">
            {" "}
            BiblioTech{" "}
          </Link>
          2023© Copyright
